  ...
  render() {
    return (
      <Container>
        ...
        <p>
          Houdini combines superior performance and dramatic, ease-of-use to
          deliver a powerful and accessible 3D experience to VFX artists
          creating feature films, commercials or video games. With its
          procedural node-based workflow, Houdini lets you create more content
          faster to reduce timelines and enjoy enhanced flexibility in all your
          creative tasks. Houdini is perfect for Visual Effects artists and
          technical directors with its particle and dynamics environment.
          Houdini includes a complete toolset for studios that want to use it
          for other tasks such as lighting, animation or procedural modeling.
        </p>
